 ...
 <?php
	...
	?>
			<form name="delogin" action="controller/actions.php" method="POST">
	...
	?>
			<form name="login" action="controller/actions.php" method="POST" onSubmit="return validLogin()">
	...
	?>
		<form name="inscription" action="view/inscription.php" method="POST">
			<!-- Unsubmit -->
	...
	function displayAddForm(){
		if (isset($_SESSION["pseudo"])){
		?>
			<form name="blagues" action="controller/actions.php" method="POST" onSubmit="return valid()">
	...
	function displayDeleteForm(){		
		if (isset($_SESSION["pseudo"]) && isset($_SESSION["admin"])){
			...
			{
		?>
				<form name="deleteBlagues" action="controller/actions.php" method="POST">
	...
	function boutonJaime($row)
	{
		if(isset($_SESSION['pseudo']))
		{
			...
			echo "<form method='post' name='Like' action='controller/actions.php'>";
	...
	function commentaire($row)
	{
		if(isset($_SESSION['pseudo']))
		{
			echo "<form method='post' name='com' action='controller/actions.php'>";
