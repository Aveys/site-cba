			...
			<div id="all">
				<div id="content">
					...
					if (isset($_POST["nom"])){
						...
						require_once("stul_config.php");
   						require_once("model/connect.php");
						mysql_query("insert into STUL_UPLOAD(upload_filename, upload_dir, upload_date,upload_type,upload_description) values ('image_default','".$_SERVER['DOCUMENT_ROOT'].$nom."/avatars/',now(),'IMG','image par defaut')");
						//print_r($configFile);
						foreach ($configFile as $line_num => $line) {
							//echo $nom;
